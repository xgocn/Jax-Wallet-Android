...
import static com.jaxwallet.app.C.DEFAULT_GAS_LIMIT_FOR_NONFUNGIBLE_TOKENS;
...
import com.jaxwallet.app.walletconnect.entity.WCEthereumSignMessage;
import com.jaxwallet.app.walletconnect.entity.WCEthereumTransaction;
import com.jaxwallet.app.walletconnect.entity.WCPeerMeta;
import com.jaxwallet.app.walletconnect.entity.WalletConnectCallback;
    ...
    private ActionSheetDialog generateTransactionRequest(Web3Transaction w3Tx, long chainId)
    {
        ...
        try
        {
                    ...
                    || (!w3Tx.recipient.equals(Address.EMPTY) && (w3Tx.payload != null || w3Tx.value != null))) // Raw or Function TX
            {
                ...
                viewModel.calculateGasEstimate(viewModel.getWallet(), com.jaxwallet.token.tools.Numeric.hexStringToByteArray(w3Tx.payload),
